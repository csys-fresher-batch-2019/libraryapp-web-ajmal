...
<body>
    ...
    <jsp:include page="adminheader.jsp"></jsp:include>
          <div class="container">
        <h2><center>Book Renewal</center></h2>
        <center><jsp:include page="message.jsp"></jsp:include></center>
      <form action="BookRenewalServlet" method="GET">
          <div class="form-group">
            <label for="number"name="bookid">BookId:</label>
            <input type="number" class="form-control" placeholder="Enter BookId" id="number" name="bookid" required autofocus>
          </div>
          <div class="form-group">
            <label for="number"name="studentid">StudentId:</label>
