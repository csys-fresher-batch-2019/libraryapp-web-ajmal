...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            ...
            <li class="nav-item dropdown">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="displayallbooks.jsp" class="dropdown-item">List</a>
      ...
      <div class="jumbotron jumbotron-fluid">
        <div class="container">
          <h2><center>Search By StudentId </center></h2>
        <form action="searchByStudentIdServlet" method="GET">
            <div class="form-group">
              <label for="number">StudentId:</label>
              <input type="number" class="form-control" placeholder="Enter StudentId" id="number" required autofocus>
            </div>
