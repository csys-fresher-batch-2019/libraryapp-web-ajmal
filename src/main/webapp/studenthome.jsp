    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        ...
        <ul class="navbar-nav">
            <li class="nav-item active">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="#" class="dropdown-item">Search By Name</a>
                    <a href="#" class="dropdown-item">Search By ID</a>
                   <div class="dropdown-divider"></div>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    <a href="#" class="dropdown-item">Availability Status</a>
                    <a href="#" class="dropdown-item">Already Taken</a>
                    <a href="#" class="dropdown-item">List Taken books</a>
                    <a href="#" class="dropdown-item">Total Fine Amount</a>
